...
useGSAP(()=>{/*making the function animate*/
  ...
  return (
    <>
      ...
      {showContent && (<div className="main w-full rotate-[-10deg] scale-[1.2] ">
        ...
        <div className="landing overflow-hidden relative w-full h-screen bg-black">
          ...
          <div className="imagesdiv relative overflow-hidden w-full h-screen">
            ...
            <img className="absolute character -bottom-[150%] left-1/2 -translate-x-1/2 scale-[1.5] rotate-[-20deg]" src="./girlbg.png" alt="" />
